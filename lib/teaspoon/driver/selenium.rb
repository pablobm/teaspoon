  ...
  module Driver
    class Selenium < Base
      ...
      def run_specs(runner, url)
        client_driver_opts = driver_options.fetch(:client_driver_opts, {}).symbolize_keys
        driver = ::Selenium::WebDriver.for(driver_options[:client_driver], client_driver_opts)
